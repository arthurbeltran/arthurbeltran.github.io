...
$('.odu_i_mc_item, .odu_i_cb_item, .odu_i_fi_item, .odu_i_drop_item').click(function(){//remove the validate box upon click
...
if (odu_i_count_mc==odu_i_counter_mc && odu_i_count_cb<=odu_i_counter_cb.length && odu_i_count_drop==odu_i_counter_drop_length && odu_i_count_fi==odu_i_counter_fi_length){
